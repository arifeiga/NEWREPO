    ...
    <footer class="footer">
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><a href="#">ARMASO</a></li>
                <li><a href="#">PSB Ar-Rahmat</a></li>
        ...
        <div class="footer-col">
            ...
            <div class="social-icons">
                <a href="https://www.youtube.com/@ArRahmatOfficial"><i class="fab fa-youtube"></i></a>
                <a href="https://www.instagram.com/arrahmat_bjn"><i class="fab fa-instagram"></i></a>
